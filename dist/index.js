import React, { useState, useRef, useEffect, Component, isValidElement, PureComponent } from 'react';
...
const toArray = (thing) => {
  ...
  if (isArray$e(thing)) return thing;
  let i = thing.length;
...
const toObjectSet = (arrayOrString, delimiter) => {
  ...
  isArray$e(arrayOrString) ? define(arrayOrString) : define(String(arrayOrString).split(delimiter));
...
const PatternDetail = ({
  ...
  }, isAdmin ? /*#__PURE__*/React.createElement(ImageUploadable, {
    wrapperStyle: {
      width: '100%',
      height: '100%'
    },
  ...
  }, "x"), /*#__PURE__*/React.createElement(ImageUploadable, {
    key: i,
    wrapperStyle: {
      width: '243px',
      height: '243px',
...
var Checkboard = function Checkboard(_ref) {
  ...
  return isValidElement(children) ? React.cloneElement(children, _extends$b({}, children.props, { style: _extends$b({}, children.props.style, styles.grid) })) : React.createElement('div', { style: styles.grid });
};
...
var _default$1 = UnfoldMoreHorizontalIcon.default = function (_ref) {
  ...
  return _react2$1.default.createElement(
    ...
    _extends$5({
      ...
      style: _extends$5({ fill: fill, width: width, height: height }, style)
    }, props),
...
var _default = CheckIcon.default = function (_ref) {
  ...
  return _react2.default.createElement(
    ...
    _extends$1({
      ...
      style: _extends$1({ fill: fill, width: width, height: height }, style)
    }, props),
...
const PatternName = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onBlur: onBlur
  }, text), isEdit && /*#__PURE__*/React.createElement("div", {
...
const PostContent = ({
  ...
  }, Array.isArray(data) && data.map((item, i) => renderItemByType(item ? item : {}, i, styles, onDeleteContentItem, addNewContentItem, isMobile, _isEdit, data, onChangeData)), _isEdit && Array.isArray(data) && data.length == 0 && /*#__PURE__*/React.createElement(MenuAddComponentPost, {
    menuItems: Object.keys(POST_ITEM_TYPE),
    btnClass: `${menuBtnClass ? ' ' + menuBtnClass : ''}`,
    onClickMenuItem: item => {
      addNewContentItem(item);
    }
  }), _isShowBigMenu && /*#__PURE__*/React.createElement(AdminMenu, {
    isEdit: _isEdit,
...
const wrapperActionAdmin = (item, index, styles = {}, onDeleteContentItem = () => {}, onAddNewContentItem = () => {}) => {
  ...
  }, /*#__PURE__*/React.createElement(MenuAddComponentPost, {
    menuItems: Object.keys(POST_ITEM_TYPE),
...
const renderItemByType = ({
  ...
  switch (type) {
    ...
    case POST_ITEM_TYPE.SMALL_HEADER:
      ...
      break;
    case POST_ITEM_TYPE.RELATED_TOPIC:
      editComponent = /*#__PURE__*/React.createElement(RelatedToMenu, {
        url: url,
        text: text,
        textLink: textLink,
        onDragStart: onDragStart,
    ...
    case POST_ITEM_TYPE_SUBMENU.IMAGE[2]:
       ...
       */
      if (urlWeb) {
        editComponent = /*#__PURE__*/React.createElement(ImageUpload, {
          width: webWidth,
          height: webHeight,
    ...
    case POST_ITEM_TYPE.ADS:
      ...
      viewComponent = /*#__PURE__*/React.createElement(AdBanner, null);
      break;
    case POST_ITEM_TYPE.VIDEO:
      editComponent = /*#__PURE__*/React.createElement(PostVideo, {
        onDragStart: onDragStart,
        url: url,
    ...
    case POST_ITEM_TYPE.SUBCRIBE_ME:
      ...
      }, /*#__PURE__*/React.createElement(YouTubeSubscribe, {
    ...
    case POST_ITEM_TYPE.BUY_ME_A_COFFEE:
      ...
      break;
    case POST_ITEM_TYPE.PATTERN:
      subContent = /*#__PURE__*/React.createElement(PatternDetail, _extends({
      ...
      break;
    case POST_ITEM_TYPE.PATTERN_PREVIEW:
      subContent = /*#__PURE__*/React.createElement(PatternPreview, {
