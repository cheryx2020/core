...
const POST_TYPES = {
    ...
    [POST_ITEM_TYPE.PATTERN]: {
        className: 'wrapper',
        tagName: 'DIV',
        expectedText: '<div class=\"mainImage\"><img alt=\"pattern name\" src=\"bigImageUrl\"></div><div class=\"rightInfo\"><h1 contenteditable=\"false\" class=\"title\">pattern name</h1><div class=\"author\">By Cheryx</div><div contenteditable=\"false\" class=\"price\"><div class=\"\">100 USD</div></div></div><div class=\"storeInfo\" style=\"padding-top: 0px;\"><img alt=\"buy pattern here\" src=\"/images/pattern-store.png\"><div class=\"payPalWrapper\"><div class=\"closeLink\">Close</div><div class=\"payPal\" id=\"paypal-button-container\"></div></div><a rel=\"noreferrer\" style=\"position: relative;\" href=\"ravelryUrl\" target=\"_blank\" class=\"linkStore mb11\">Ravelry</a><a rel=\"noreferrer\" href=\"lovecraftsUrl\" target=\"_blank\" class=\"linkStore mb11\">Lovecrafts</a><div class=\"linkStore\" style=\"cursor: pointer;\">Other</div></div><div class=\"listSmallImage\"><img alt=\"pattern name\" src=\"image1.png\" style=\"cursor: pointer;\"><img alt=\"pattern name\" src=\"image2.png\" style=\"cursor: pointer;\"></div>'
    },
