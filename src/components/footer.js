...
const Footer = ({isMobile, theme , socialLinkStyle = {}, socialTitle = "Tài khoản cá nhân", image = "https://gocnhacolen.com/images/footer.webp", className, isAdmin}) => {
    return <footer className={`${styles.footer} ${className}`}>
    <MySocialLink theme={theme} title={socialTitle} style={socialLinkStyle} isMobile={isMobile}/>
