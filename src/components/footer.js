...
const Footer = ({isMobile, socialLinkStyle = {}, socialTitle = "Tài khoản cá nhân", image = "https://gocnhacolen.com/images/footer.webp", className, isAdmin}) => {
    return <footer className={`${styles.footer} ${className}`}>
    <MySocialLink title={socialTitle} style={socialLinkStyle} isMobile={isMobile}/>
