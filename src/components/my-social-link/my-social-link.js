...
const MySocialLink = ({ isMobile, title, theme }) => {
  return <ContentWithTitle
    ...
    content={
      <div className={styles.items}>
        ...
        <a rel="noreferrer" target="_blank" href="https://www.instagram.com/cheryx.knitadream"><img alt="Instagram" width={isMobile ? '21px' : '32px'} height={isMobile ? '21px' : '34px'} className={styles.inIcon} src="/images/in1.png" /></a>
