...
const MainLayout = ({ theme, mainImageUrl, Link, Head, NextSeo, isMobile, sublinkData = [], subLinkStyle = {}, sublinkClassName='', content, title, url, seoConfig, description, MenuData = [], footer = {}, isAdmin}) => {
